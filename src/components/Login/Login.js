            ...
            <Container>
                <div className="login-wrapper d-flex justify-content-center align-items-center  ">
                    ...
                    <form onSubmit={formPreventDefault} className="login-form d-flex flex-column justify-content-center align-items-center mt-5">
                        ...
                        <button className="button submit" onClick={handleLogIn}>Login</button>
                        <p className="mt-2 mb-2 green-text">Or</p>
                        <button className="button submit" onClick={signInUsingGoogle}> Continue with <FcGoogle /></button>
                        <Link to="/register" className="new-here mt-2">New here? Register</Link>
                    </form>
                </div>
            </Container>
        </div>
