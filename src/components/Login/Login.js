            ...
            <Container>
                <div className="login-wrapper d-flex justify-content-center align-items-center  ">
                    ...
                    <form
                        ...
                        className="login-form d-flex flex-column justify-content-center align-items-center mt-5"
                    >
                        <div>
                        ...
                        <button className="button submit" onClick={signInUsingGoogle}>
                            {" "}
                            Continue with <FcGoogle />
                        </button>
                        <Link to="/register" className="new-here mt-2">
                            New here? Register
                        </Link>
                    </form>
                </div>
