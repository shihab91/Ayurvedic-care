                ...
                <div className="login-wrapper d-flex justify-content-center align-items-center">
                    <form onSubmit={formPreventDefault} className="login-form d-flex flex-column justify-content-center align-items-center mt-5">
                        <div>
                            ...
                            <input onBlur={handleSetName} className="input" placeholder="Enter your name" />
                        </div>
                        <div>
                        ...
                        <button className="button submit" onClick={createNewUser}>Register</button>
                        ...
                        <Link to="/login" className="new-here mt-2">Already have an account?</Link>
                    </form>
