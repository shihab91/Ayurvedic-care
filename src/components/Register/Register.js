        ...
        <div>
            <Container>
                <div className="login-wrapper d-flex justify-content-center align-items-center">
                    ...
                    <form onSubmit={handleSubmit(onSubmit)} className="login-form d-flex flex-column justify-content-center align-items-center mt-5">
                        <div>
                            <label htmlFor="firstName">First Name</label><br />
                            <input className="input" placeholder="Enter your name" {...register("firstName")} />
                        </div>
                        <div>
                        ...
                        <button className="button submit "> Continue with <FcGoogle /></button>
                    </form>
                </div>
            </Container>
        </div>
